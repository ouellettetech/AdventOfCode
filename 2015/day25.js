...
function getInstance(row,column){
	var slice = row+column-1;
	var numbersBeforeSliceStart = ((slice-1)*(slice))/2;
	return numbersBeforeSliceStart+column;
}

function generateCode(numberOfCodes){
...
function testData(){
	var instanceNum = getInstance(6,6);
	console.log(instanceNum);
	console.log(generateCode(instanceNum));
}

function day25a(row,column){
	var instanceNum = getInstance(row,column);
	return generateCode(instanceNum);
}
...
testData();
console.log("Day 25 Part A");
console.log(day25a(2947, 3029));
